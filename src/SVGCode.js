...
const FingerIcon = () => {
  ...
  useEffect(() => {
    ...
    animation.start();
    return () => animation.stop(); // Stop the animation on component unmount
  }, [animatedValue]);

  const pathOpacity = animatedValue.interpolate({
    inputRange: [0, 1],
    outputRange: [0, 1],
  });
  ...
  return (
    <View style={styles.container}>
      <Svg style={{ transform: [{ scale: 1.5 }] }} width="100%" height="100%">
        <AnimatedPath
